            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                <Image
                  ...
                  alt="Loida Azules Suárez - Abogada"
                  width={600}
                  height={700}
          ...
          <ScrollAnimation>
            <div className="space-y-6">
              ...
              <div className="space-y-4 font-[family-name:var(--font-inter)] text-lg text-gray-600">
                ...
                <p>
                  Colegiada en el Ilustre Colegio de la Abogacía de Barcelona (ICAB), trabajo incansablemente para asegurar que cada persona reciba la defensa que merece.
                </p>
              </div>
